...
const refereeRoles = ['role_headref', 'role_ref', 'role_obs'];
...
export default function RefereesPage() {
  ...
  const filteredUsers = users.filter(u => {
    ...
    const matchesReferee = u.roles.some(role => refereeRoles.includes(role));
    ...
    return matchesGame && matchesRegion && matchesReferee && matchesRole && matchesStatus && matchesSearch;
  });
      ...
      <div className="flex flex-col sm:flex-row items-center justify-between bg-white dark:bg-[#16181d] p-4 rounded-t-2xl border border-b-0 border-gray-200 dark:border-gray-800/60 mt-6 gap-4">
        ...
        <div className="flex items-center gap-3 w-full sm:w-auto flex-wrap">
          ...
          >
            ...
            {allRoles
              .filter(r => refereeRoles.includes(r.id))
                  ...
                  >
                    ...
                    <td className="px-6 py-4">
                      <div className="flex gap-1 flex-wrap">
                        {user.roles.filter(r => refereeRoles.includes(r)).map(role => (
